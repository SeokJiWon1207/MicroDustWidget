package com.example.microdustwidget.widget
...
class AirPollutionWidgetProvider: AppWidgetProvider() {
    ...
    class UpdateWidgetService : LifecycleService() {
        ...
        override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
            if (
                ...
                val updateViews = RemoteViews(packageName, R.layout.layout_widget).apply {
                ...
                .addOnSuccessListener { location ->
                    lifecycleScope.launch {
                        try {
                            ...
                            val measuredValue =
                                Repository.getLatestAirPollution(nearbyMonitoringStation!!.stationName!!)

                            val updateViews =
                                RemoteViews(packageName, R.layout.layout_widget).apply {
        ...
        private fun updateWidget(updateViews: RemoteViews) {
            val widgetProvider = ComponentName(this, AirPollutionWidgetProvider::class.java)
